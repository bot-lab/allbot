...
class AllBot {
    ...
    onMessage(listener){
        this.on(Const.eventTypeMessage,listener);
    }
    ...
    processToAdaptersWithService(req,res,service){
        ...
        if(req.method == "POST"){
            ...
            processed |= adapter.processPost(req,res,service,(eventType,message,responseFromProvider) => {
                ...
                listeners.forEach((listener) => {
                    ...
                    if(typeof listener === 'function'){
                        ...
                        setTimeout(() => {
                            ...
                            if(eventType == Const.eventTypeMessage){
                            ...
                            else if(eventType == Const.eventTypeOpenChat){
