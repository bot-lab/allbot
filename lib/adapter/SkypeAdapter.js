...
class SkypeAdapter extends BaseAdapter {
    ...
    initializeBotbuilders(configAry){
        ...
        configAry.forEach((setting) => {
            ...
            bot.on('contactRelationUpdate',  (message) => {
                ...
                console.log('skype contactRelationUpdate update',message);
                ...
                if (message.action === 'add') {
                    ...
                    this.userIdentifierPool[message.user.id] = session.message.address;
    ...
    generateOpenChatObj(service,message){
        ...
        const messageObj = {
            userIdentifier:service.provider + ":" + service.identifier + ":" + message.user.id,
            providerIdentifier:service.identifier,
            provider:service.provider,
            providerUserId:message.user.id
        };
