...
class FacebookAdapter extends BaseAdapter {
            ...
            data.entry.forEach((entry) => {
                ...
                if(entry.messaging){
                    ...
                    entry.messaging.forEach((event) => {
                        ...
                        if(event.referral && event.referral.type == 'OPEN_THREAD' && cb){
                            cb(
                                Const.eventTypeOpenChat,
                                this.generateOpenChatObj(service,event),
                                event
                            );
                        }
    ...
    generateOpenChatObj(service,webhookRequest){
